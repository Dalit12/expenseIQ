    ...
    return (
        <footer className="px-3 pt-4 lg:px-9 border-t-2 bg-blue-400">
            <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="sm:col-span-2">
                    ...
                    <div className="mt-6 lg:max-w-xl">
                        ...
                        ExpenseIQ helps you effortlessly manage daily transactions with quick recording and easy categorization for income and expenses. Get clear insights into your spending habits through simple, visually appealing reports. Seamlessly import and export data using CSV support to analyze your finances with ease.
                        </p>
                    </div>
                </div>
            ...
            <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
                <p className="text-sm text-white">© Copyright 2024 ExpenseIQ. All rights reserved.</p>
