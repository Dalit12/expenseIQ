      ...
      {loginForm ? (
        <div className='signup-wrapper w-[70%] max-w-[450px] h-auto rounded-[1rem] px-[1.5rem] py-[1rem]'>
          <h2 className='title font-medium text-[1.2rem] text-center mb-3'>
            Login on <span style={{ color: "var(--theme)" }} className='text-xl font-semibold'>ExpenseIQ</span>
          </h2>
        ...
        <div className='signup-wrapper w-[70%] max-w-[450px] h-auto rounded-[1rem] px-[1.5rem] py-[1rem]'>
          <h2 className='title font-medium text-[1.2rem] text-center mb-3'>
            Sign Up on <span style={{ color: "var(--theme)" }} className='text-xl font-semibold'>ExpenseIQ</span>
          </h2>
          <form className='gap-2' >
